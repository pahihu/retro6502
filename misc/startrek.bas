REM RETYPED MARCH 2005 BY PETE TURNBULL - BLAME HIM FOR BUGS/TYPOS
  10 DIM C$(6),D$(15)
  20 Q=640:S=704:D$="    * >!<+++<*>"
  ...
  70 K1=7:N=K1:V=20:L=40: GOSUB 1200
 ...
 520 E1=E1-C: GOSUB 1800: K5=K5-C/R: IF K5>0 THEN 530: GOSUB 1900: GOTO 110
...
1010 N=S2:Y=1:L=2: GOSUB 1200
1020 N=K2:Y=3:L=4: GOSUB 1200: K5=100:Y5=I/8:X5=I-8*Y5
1030 N=B2:Y=2:L=3: GOSUB 1200: Y6=I/8:X6=I-8*Y6
...
1070 IF P=1 THEN PRINT "STAR";: IF P=2 THEN PRINT "STARBASE";: IF P=2 THEN PRINT "KLINGON";
1080 PRINT " ***" IF P=3 THEN K1=K1=1: GOTO 990
1100 FOR K=0 TO 63: POKE B+K,0: NEXT K: RETURN
1200 IF N=0 THEN RETURN : FOR K=1 TO N
1210 I= RND (64):P= PEEK (B+I): IF P+Y>=L THEN 1210: POKE B+I,P+Y: NEXT K: RETURN
...
2010 FOR Y=0 TO 7 STEP -1: FOR X=0 TO 7
2020 P=8* PEEK (S+X+8*Y)+1: IF X=0 THEN PRINT "!";: IF X#0 THEN PRINT " ";: PRINT C$(P,P+2);
